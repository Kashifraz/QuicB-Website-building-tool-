                                           ...
                                           {props.components.map((component) => (
                                                <>
                                                    <li class="py-3 sm:py-4">
                                                            ...
                                                            <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                                                <div class="inline-flex " >
                                                                    <button
                                                                        ...
                                                                        id={component.id}
                                                                        tabIndex="-1"
                                                                        type="button" class="bg-red-700 text-white active:bg-red-800 font-bold text-sm px-3  rounded-lg shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-3 ease-linear transition-all duration-150">
                                                                        Delete
                                                                    </button>
                                                        ...
                                                        {component.elements.length == 0 ? (<> <div className="mt-6 ml-16">No elements added yet</div> </>): (
                                                            <>
