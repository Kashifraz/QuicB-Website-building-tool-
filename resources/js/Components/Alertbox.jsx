...
export default function Alertbox(props) {
    ...
    return (
      ...
      {show && (
       ...
       <div class="ml-3 text-md font-medium text-blue-700 dark:text-blue-800">
         {props.message}
       </div>
         <button type="button" onClick={()=>setShow(false)} class="ml-auto -mx-1.5 -my-1.5 bg-blue-100 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex h-8 w-8 dark:bg-blue-200 dark:text-blue-600 dark:hover:bg-blue-300" data-dismiss-target="#alert-1" aria-label="Close">
